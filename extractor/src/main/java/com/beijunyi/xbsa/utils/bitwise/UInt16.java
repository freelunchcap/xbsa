...
public class UInt16 extends Number implements Serializable, Comparable, Bitwise<UInt16> {
  ...
  public UInt16(byte[] paramArrayOfByte) throws IllegalArgumentException {
  ...
  public static UInt16 valueOfBigEndian(byte[] paramArrayOfByte) throws IllegalArgumentException {
    verify(paramArrayOfByte);
    return new UInt16(paramArrayOfByte);
  }

  public static UInt16 valueOfLittleEndian(byte[] paramArrayOfByte) throws IllegalArgumentException {
    verify(paramArrayOfByte);

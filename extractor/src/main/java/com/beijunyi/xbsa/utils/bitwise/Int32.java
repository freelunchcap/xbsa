...
public class Int32 extends Number implements Serializable, Comparable, Bitwise<Int32> {
  ...
  public Int32(byte[] paramArrayOfByte) throws IllegalArgumentException {
  ...
  public static Int32 valueOfBigEndian(byte[] paramArrayOfByte) throws IllegalArgumentException {
    verify(paramArrayOfByte);
    return new Int32(paramArrayOfByte);
  }

  public static Int32 valueOfLittleEndian(byte[] paramArrayOfByte) throws IllegalArgumentException {
    verify(paramArrayOfByte);

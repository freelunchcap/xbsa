...
public class UInt32 extends Number implements Serializable, Comparable, Bitwise<UInt32> {
  ...
  public UInt32(byte[] paramArrayOfByte) throws IllegalArgumentException {
  ...
  public static UInt32 valueOfBigEndian(byte[] paramArrayOfByte) throws IllegalArgumentException {
    verify(paramArrayOfByte);
    return new UInt32(paramArrayOfByte);
  }

  public static UInt32 valueOfLittleEndian(byte[] paramArrayOfByte) throws IllegalArgumentException {
    verify(paramArrayOfByte);
  ...
  private static void verify(byte[] paramArrayOfByte) throws IllegalArgumentException {

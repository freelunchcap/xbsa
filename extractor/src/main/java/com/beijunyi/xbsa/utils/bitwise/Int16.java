...
public class Int16 extends Number implements Serializable, Comparable, Bitwise<Int16> {
  ...
  public Int16(byte[] paramArrayOfByte) throws IllegalArgumentException {
  ...
  public static Int16 valueOfBigEndian(byte[] paramArrayOfByte) throws IllegalArgumentException {
    verify(paramArrayOfByte);
    return new Int16(paramArrayOfByte);
  }

  public static Int16 valueOfLittleEndian(byte[] paramArrayOfByte) throws IllegalArgumentException {
    verify(paramArrayOfByte);
